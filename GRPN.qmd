---
title: "Groupon, Inc. (GRPN) - Stock Pitch"
...
* **Key Financial Metrics (TTM or 5Yr Avg):**
    * **Margins:**
...
* **TTM Valuation Multiples:**
    * P/E: **-32.9** (due to negative TTM earnings).
    * P/B: **28.3** (exceptionally high, especially with negative 5yr avg ROE and current equity of only ~$45.5M).
...
* **NTM Valuation Multiples:**
    * P/E: **404.8** (extremely high, implying very low expected NTM EPS).
